/**
 * Agents Adapter - Tool Definitions
 */

import { z } from 'zod'
import type { AdapterTool } from '../../gateway/types.js'
import { createLogger } from '../../utils/logger.js'
import type { BullMQWorkflowClient } from '@elio/workflow'
...
export function createTools(getClient: () => BullMQWorkflowClient): AdapterTool[] {
  return [
    {
