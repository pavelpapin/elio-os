...
export default function V2() {
  return (
    <div className="min-h-screen bg-[#08090A] text-white/90 font-sans v2-noise">
      ...
      {/* Private pilot */}
      <Section id="pilot">
        <FadeIn><SectionLabel>Private pilot</SectionLabel></FadeIn>
        <div className="grid grid-cols-1 sm:grid-cols-[1fr_1fr] gap-10 sm:gap-20">
          <FadeIn delay={100}>
            <div>
              ...
              <p className="mt-4 text-[16px] sm:text-[17px] text-white/40 leading-[1.7]">
                30-day pilot. Limited availability.
              </p>
              <div className="mt-6 space-y-1 text-[15px] text-white/30">
                <p>Minimal setup.</p>
                <p>Direct access.</p>
              </div>
              <div className="mt-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-[1fr_auto_auto] gap-10 sm:gap-16">
            ...
            <div>
              ...
              <div className="space-y-2.5">
                <a href="#pilot" className="block text-[13px] text-white/40 hover:text-white/60 transition-colors">Private pilot</a>
